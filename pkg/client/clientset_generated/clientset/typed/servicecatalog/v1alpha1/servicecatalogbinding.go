...
type ServiceCatalogBindingInterface interface {
	Create(*v1alpha1.ServiceCatalogBinding) (*v1alpha1.ServiceCatalogBinding, error)
	Update(*v1alpha1.ServiceCatalogBinding) (*v1alpha1.ServiceCatalogBinding, error)
	UpdateStatus(*v1alpha1.ServiceCatalogBinding) (*v1alpha1.ServiceCatalogBinding, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ServiceCatalogBinding, error)
	List(opts v1.ListOptions) (*v1alpha1.ServiceCatalogBindingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ServiceCatalogBinding, err error)
...
func newServiceCatalogBindings(c *ServicecatalogV1alpha1Client, namespace string) *serviceCatalogBindings {
...
func (c *serviceCatalogBindings) Create(serviceCatalogBinding *v1alpha1.ServiceCatalogBinding) (result *v1alpha1.ServiceCatalogBinding, err error) {
	result = &v1alpha1.ServiceCatalogBinding{}
	err = c.client.Post().
		Namespace(c.ns).
...
func (c *serviceCatalogBindings) Update(serviceCatalogBinding *v1alpha1.ServiceCatalogBinding) (result *v1alpha1.ServiceCatalogBinding, err error) {
	result = &v1alpha1.ServiceCatalogBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicecatalogbindings").
...
func (c *serviceCatalogBindings) UpdateStatus(serviceCatalogBinding *v1alpha1.ServiceCatalogBinding) (result *v1alpha1.ServiceCatalogBinding, err error) {
	result = &v1alpha1.ServiceCatalogBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicecatalogbindings").
...
func (c *serviceCatalogBindings) Get(name string, options v1.GetOptions) (result *v1alpha1.ServiceCatalogBinding, err error) {
	result = &v1alpha1.ServiceCatalogBinding{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicecatalogbindings").
...
func (c *serviceCatalogBindings) List(opts v1.ListOptions) (result *v1alpha1.ServiceCatalogBindingList, err error) {
	result = &v1alpha1.ServiceCatalogBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicecatalogbindings").
...
func (c *serviceCatalogBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ServiceCatalogBinding, err error) {
	result = &v1alpha1.ServiceCatalogBinding{}
