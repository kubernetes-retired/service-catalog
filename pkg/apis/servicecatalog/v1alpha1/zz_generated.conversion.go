...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_SecretReference_To_servicecatalog_SecretReference,
		Convert_servicecatalog_SecretReference_To_v1alpha1_SecretReference,
...
func autoConvert_v1alpha1_Parameter_To_servicecatalog_Parameter(in *Parameter, out *servicecatalog.Parameter, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = servicecatalog.ParameterValueType(in.Type)
	out.Value = in.Value
	out.ValueFrom = (*servicecatalog.ParameterSource)(unsafe.Pointer(in.ValueFrom))
	return nil
}

// Convert_v1alpha1_Parameter_To_servicecatalog_Parameter is an autogenerated conversion function.
...
func autoConvert_servicecatalog_Parameter_To_v1alpha1_Parameter(in *servicecatalog.Parameter, out *Parameter, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = ParameterValueType(in.Type)
	out.Value = in.Value
	out.ValueFrom = (*ParameterSource)(unsafe.Pointer(in.ValueFrom))
	return nil
}

// Convert_servicecatalog_Parameter_To_v1alpha1_Parameter is an autogenerated conversion function.
...
// Convert_v1alpha1_ParameterSource_To_servicecatalog_ParameterSource is an autogenerated conversion function.
...
// Convert_servicecatalog_ParameterSource_To_v1alpha1_ParameterSource is an autogenerated conversion function.
...
func autoConvert_v1alpha1_SecretReference_To_servicecatalog_SecretReference(in *SecretReference, out *servicecatalog.SecretReference, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = servicecatalog.ParameterValueType(in.Type)
	return nil
}

// Convert_v1alpha1_SecretReference_To_servicecatalog_SecretReference is an autogenerated conversion function.
func Convert_v1alpha1_SecretReference_To_servicecatalog_SecretReference(in *SecretReference, out *servicecatalog.SecretReference, s conversion.Scope) error {
	return autoConvert_v1alpha1_SecretReference_To_servicecatalog_SecretReference(in, out, s)
}

func autoConvert_servicecatalog_SecretReference_To_v1alpha1_SecretReference(in *servicecatalog.SecretReference, out *SecretReference, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = ParameterValueType(in.Type)
	return nil
}

// Convert_servicecatalog_SecretReference_To_v1alpha1_SecretReference is an autogenerated conversion function.
func Convert_servicecatalog_SecretReference_To_v1alpha1_SecretReference(in *servicecatalog.SecretReference, out *SecretReference, s conversion.Scope) error {
	return autoConvert_servicecatalog_SecretReference_To_v1alpha1_SecretReference(in, out, s)
}
