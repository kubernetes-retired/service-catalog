...
=======
		Convert_v1beta1_SharedServiceBrokerSpec_To_servicecatalog_SharedServiceBrokerSpec,
		Convert_servicecatalog_SharedServiceBrokerSpec_To_v1beta1_SharedServiceBrokerSpec,
...
func autoConvert_v1beta1_ClusterServiceBrokerSpec_To_servicecatalog_ClusterServiceBrokerSpec(in *ClusterServiceBrokerSpec, out *servicecatalog.ClusterServiceBrokerSpec, s conversion.Scope) error {
	if err := Convert_v1beta1_SharedServiceBrokerSpec_To_servicecatalog_SharedServiceBrokerSpec(&in.SharedServiceBrokerSpec, &out.SharedServiceBrokerSpec, s); err != nil {
		return err
	}
...
func autoConvert_servicecatalog_ClusterServiceBrokerSpec_To_v1beta1_ClusterServiceBrokerSpec(in *servicecatalog.ClusterServiceBrokerSpec, out *ClusterServiceBrokerSpec, s conversion.Scope) error {
	if err := Convert_servicecatalog_SharedServiceBrokerSpec_To_v1beta1_SharedServiceBrokerSpec(&in.SharedServiceBrokerSpec, &out.SharedServiceBrokerSpec, s); err != nil {
		return err
	}
...
=======
func autoConvert_v1beta1_SharedServiceBrokerSpec_To_servicecatalog_SharedServiceBrokerSpec(in *SharedServiceBrokerSpec, out *servicecatalog.SharedServiceBrokerSpec, s conversion.Scope) error {
	out.URL = in.URL
...
// Convert_v1beta1_SharedServiceBrokerSpec_To_servicecatalog_SharedServiceBrokerSpec is an autogenerated conversion function.
func Convert_v1beta1_SharedServiceBrokerSpec_To_servicecatalog_SharedServiceBrokerSpec(in *SharedServiceBrokerSpec, out *servicecatalog.SharedServiceBrokerSpec, s conversion.Scope) error {
	return autoConvert_v1beta1_SharedServiceBrokerSpec_To_servicecatalog_SharedServiceBrokerSpec(in, out, s)
}

func autoConvert_servicecatalog_SharedServiceBrokerSpec_To_v1beta1_SharedServiceBrokerSpec(in *servicecatalog.SharedServiceBrokerSpec, out *SharedServiceBrokerSpec, s conversion.Scope) error {
	out.URL = in.URL
	out.InsecureSkipTLSVerify = in.InsecureSkipTLSVerify
	out.CABundle = *(*[]byte)(unsafe.Pointer(&in.CABundle))
...
// Convert_servicecatalog_SharedServiceBrokerSpec_To_v1beta1_SharedServiceBrokerSpec is an autogenerated conversion function.
func Convert_servicecatalog_SharedServiceBrokerSpec_To_v1beta1_SharedServiceBrokerSpec(in *servicecatalog.SharedServiceBrokerSpec, out *SharedServiceBrokerSpec, s conversion.Scope) error {
	return autoConvert_servicecatalog_SharedServiceBrokerSpec_To_v1beta1_SharedServiceBrokerSpec(in, out, s)
>>>>>>> Update generated files for a successful build
}
