...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "PodPresetBinding Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("PodPresetBindingController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("PodPresetBindingController")
})
