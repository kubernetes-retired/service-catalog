...
type ServiceCatalogInstanceInterface interface {
	Create(*v1alpha1.ServiceCatalogInstance) (*v1alpha1.ServiceCatalogInstance, error)
	Update(*v1alpha1.ServiceCatalogInstance) (*v1alpha1.ServiceCatalogInstance, error)
	UpdateStatus(*v1alpha1.ServiceCatalogInstance) (*v1alpha1.ServiceCatalogInstance, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.ServiceCatalogInstance, error)
	List(opts v1.ListOptions) (*v1alpha1.ServiceCatalogInstanceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ServiceCatalogInstance, err error)
...
func newServiceCatalogInstances(c *ServicecatalogV1alpha1Client, namespace string) *serviceCatalogInstances {
...
func (c *serviceCatalogInstances) Create(serviceCatalogInstance *v1alpha1.ServiceCatalogInstance) (result *v1alpha1.ServiceCatalogInstance, err error) {
...
func (c *serviceCatalogInstances) Update(serviceCatalogInstance *v1alpha1.ServiceCatalogInstance) (result *v1alpha1.ServiceCatalogInstance, err error) {
	result = &v1alpha1.ServiceCatalogInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicecataloginstances").
...
func (c *serviceCatalogInstances) UpdateStatus(serviceCatalogInstance *v1alpha1.ServiceCatalogInstance) (result *v1alpha1.ServiceCatalogInstance, err error) {
	result = &v1alpha1.ServiceCatalogInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicecataloginstances").
...
func (c *serviceCatalogInstances) Get(name string, options v1.GetOptions) (result *v1alpha1.ServiceCatalogInstance, err error) {
	result = &v1alpha1.ServiceCatalogInstance{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicecataloginstances").
...
func (c *serviceCatalogInstances) List(opts v1.ListOptions) (result *v1alpha1.ServiceCatalogInstanceList, err error) {
	result = &v1alpha1.ServiceCatalogInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicecataloginstances").
...
func (c *serviceCatalogInstances) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ServiceCatalogInstance, err error) {
	result = &v1alpha1.ServiceCatalogInstance{}
