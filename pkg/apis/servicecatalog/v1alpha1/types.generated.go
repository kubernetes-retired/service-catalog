			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF81234, string(x.LastOperation))
					}
				} else {
					r.EncodeString(codecSelferC_UTF81234, "")
				}
...
func (x *InstanceStatus) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceInstanceCondition((*[]InstanceCondition)(yyv11), d)
		}
	}
	yyj10++
	if yyhl10 {
