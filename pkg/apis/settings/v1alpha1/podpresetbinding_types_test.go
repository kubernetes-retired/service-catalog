...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the PodPresetBinding resource tests

var _ = Describe("PodPresetBinding", func() {
    var instance PodPresetBinding
    var expected PodPresetBinding
