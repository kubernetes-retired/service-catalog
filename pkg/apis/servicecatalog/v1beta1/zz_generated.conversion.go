...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1beta1_SharedServiceClassSpec_To_servicecatalog_SharedServiceClassSpec,
		Convert_servicecatalog_SharedServiceClassSpec_To_v1beta1_SharedServiceClassSpec,
...
func autoConvert_v1beta1_ClusterServiceClassSpec_To_servicecatalog_ClusterServiceClassSpec(in *ClusterServiceClassSpec, out *servicecatalog.ClusterServiceClassSpec, s conversion.Scope) error {
	if err := Convert_v1beta1_SharedServiceClassSpec_To_servicecatalog_SharedServiceClassSpec(&in.SharedServiceClassSpec, &out.SharedServiceClassSpec, s); err != nil {
		return err
	}
...
func autoConvert_servicecatalog_ClusterServiceClassSpec_To_v1beta1_ClusterServiceClassSpec(in *servicecatalog.ClusterServiceClassSpec, out *ClusterServiceClassSpec, s conversion.Scope) error {
	if err := Convert_servicecatalog_SharedServiceClassSpec_To_v1beta1_SharedServiceClassSpec(&in.SharedServiceClassSpec, &out.SharedServiceClassSpec, s); err != nil {
		return err
	}
	out.ClusterServiceBrokerName = in.ClusterServiceBrokerName
	return nil
...
func autoConvert_v1beta1_SharedServiceClassSpec_To_servicecatalog_SharedServiceClassSpec(in *SharedServiceClassSpec, out *servicecatalog.SharedServiceClassSpec, s conversion.Scope) error {
...
// Convert_v1beta1_SharedServiceClassSpec_To_servicecatalog_SharedServiceClassSpec is an autogenerated conversion function.
func Convert_v1beta1_SharedServiceClassSpec_To_servicecatalog_SharedServiceClassSpec(in *SharedServiceClassSpec, out *servicecatalog.SharedServiceClassSpec, s conversion.Scope) error {
	return autoConvert_v1beta1_SharedServiceClassSpec_To_servicecatalog_SharedServiceClassSpec(in, out, s)
}

func autoConvert_servicecatalog_SharedServiceClassSpec_To_v1beta1_SharedServiceClassSpec(in *servicecatalog.SharedServiceClassSpec, out *SharedServiceClassSpec, s conversion.Scope) error {
	out.ExternalName = in.ExternalName
	out.ExternalID = in.ExternalID
	out.Description = in.Description
	out.Bindable = in.Bindable
...
// Convert_servicecatalog_SharedServiceClassSpec_To_v1beta1_SharedServiceClassSpec is an autogenerated conversion function.
func Convert_servicecatalog_SharedServiceClassSpec_To_v1beta1_SharedServiceClassSpec(in *servicecatalog.SharedServiceClassSpec, out *SharedServiceClassSpec, s conversion.Scope) error {
	return autoConvert_servicecatalog_SharedServiceClassSpec_To_v1beta1_SharedServiceClassSpec(in, out, s)
}
