...
func NewRESTStorage(
	...
	storage, err := v1beta1Storage(apiResourceConfigSource, restOptionsGetter)
	if err != nil {
		return nil, servicecatalog.GroupName, err
	}
	...
	return &apiGroupInfo, servicecatalog.GroupName, nil
}
