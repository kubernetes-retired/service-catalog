	...
	sharedIndexInformer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Servicecatalog().Brokers().List(internalOptions)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				...
				return client.Servicecatalog().Brokers().Watch(internalOptions)
			},
		},
...
func (f *brokerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InternalInformerFor(&servicecatalog.Broker{}, newBrokerInformer)
}
