...
type ClusterIDInterface interface {
	Create(*v1beta1.ClusterID) (*v1beta1.ClusterID, error)
	Update(*v1beta1.ClusterID) (*v1beta1.ClusterID, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.ClusterID, error)
	List(opts v1.ListOptions) (*v1beta1.ClusterIDList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ClusterID, err error)
	ClusterIDExpansion
}
...
func newClusterIDs(c *ServicecatalogV1beta1Client) *clusterIDs {
	return &clusterIDs{
		client: c.RESTClient(),
	}
}
...
func (c *clusterIDs) Get(name string, options v1.GetOptions) (result *v1beta1.ClusterID, err error) {
	result = &v1beta1.ClusterID{}
	err = c.client.Get().
		Resource("clusterids").
		Name(name).
...
func (c *clusterIDs) List(opts v1.ListOptions) (result *v1beta1.ClusterIDList, err error) {
	result = &v1beta1.ClusterIDList{}
	err = c.client.Get().
		Resource("clusterids").
...
func (c *clusterIDs) Create(clusterID *v1beta1.ClusterID) (result *v1beta1.ClusterID, err error) {
	result = &v1beta1.ClusterID{}
	err = c.client.Post().
		Resource("clusterids").
		Body(clusterID).
...
func (c *clusterIDs) Update(clusterID *v1beta1.ClusterID) (result *v1beta1.ClusterID, err error) {
	result = &v1beta1.ClusterID{}
	err = c.client.Put().
		Resource("clusterids").
		Name(clusterID.Name).
...
func (c *clusterIDs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ClusterID, err error) {
	result = &v1beta1.ClusterID{}
