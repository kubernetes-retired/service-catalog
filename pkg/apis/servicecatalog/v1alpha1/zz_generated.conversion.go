...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_Parameters_To_servicecatalog_Parameters,
		Convert_servicecatalog_Parameters_To_v1alpha1_Parameters,
...
func autoConvert_v1alpha1_InstanceSpec_To_servicecatalog_InstanceSpec(in *InstanceSpec, out *servicecatalog.InstanceSpec, s conversion.Scope) error {
	...
	out.Parameters = (*servicecatalog.Parameters)(unsafe.Pointer(in.Parameters))
	out.ExternalID = in.ExternalID
	return nil
}
...
func autoConvert_servicecatalog_InstanceSpec_To_v1alpha1_InstanceSpec(in *servicecatalog.InstanceSpec, out *InstanceSpec, s conversion.Scope) error {
	out.ServiceClassName = in.ServiceClassName
	out.PlanName = in.PlanName
	out.Parameters = (*Parameters)(unsafe.Pointer(in.Parameters))
	out.ExternalID = in.ExternalID
	return nil
}
...
func autoConvert_v1alpha1_Parameters_To_servicecatalog_Parameters(in *Parameters, out *servicecatalog.Parameters, s conversion.Scope) error {
...
// Convert_v1alpha1_Parameters_To_servicecatalog_Parameters is an autogenerated conversion function.
func Convert_v1alpha1_Parameters_To_servicecatalog_Parameters(in *Parameters, out *servicecatalog.Parameters, s conversion.Scope) error {
	return autoConvert_v1alpha1_Parameters_To_servicecatalog_Parameters(in, out, s)
}

func autoConvert_servicecatalog_Parameters_To_v1alpha1_Parameters(in *servicecatalog.Parameters, out *Parameters, s conversion.Scope) error {
	out.SecretRef = (*v1.LocalObjectReference)(unsafe.Pointer(in.SecretRef))
...
// Convert_servicecatalog_Parameters_To_v1alpha1_Parameters is an autogenerated conversion function.
func Convert_servicecatalog_Parameters_To_v1alpha1_Parameters(in *servicecatalog.Parameters, out *Parameters, s conversion.Scope) error {
	return autoConvert_servicecatalog_Parameters_To_v1alpha1_Parameters(in, out, s)
}
