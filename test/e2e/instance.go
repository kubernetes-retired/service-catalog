...
func newTestInstance(name, serviceClassName, planName string) *v1alpha1.ServiceCatalogInstance {
...
func createInstance(c clientset.Interface, namespace string, instance *v1alpha1.ServiceCatalogInstance) (*v1alpha1.ServiceCatalogInstance, error) {
	return c.ServicecatalogV1alpha1().ServiceCatalogInstances(namespace).Create(instance)
}
...
func deleteInstance(c clientset.Interface, namespace, name string) error {
	return c.ServicecatalogV1alpha1().ServiceCatalogInstances(namespace).Delete(name, nil)
}
...
func waitForInstanceToBeDeleted(c clientset.Interface, namespace, name string) error {
	return wait.Poll(framework.Poll, instanceDeleteTimeout, func() (bool, error) {
		_, err := c.ServicecatalogV1alpha1().ServiceCatalogInstances(namespace).Get(name, metav1.GetOptions{})
		if err == nil {
...
var _ = framework.ServiceCatalogDescribe("ServiceCatalogInstance", func() {
