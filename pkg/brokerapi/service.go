...
// DashboardClient represents a dashboard_client which contains the data necessary to activate
// the Dashboard SSO feature for this service.
//
// https://github.com/openservicebrokerapi/servicebroker/blob/v2.12/spec.md#dashboard-client-object
