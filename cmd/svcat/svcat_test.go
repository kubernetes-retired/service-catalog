...
func TestCommandOutput(t *testing.T) {
	testcases := []struct {
		...
		{name: "get instance filtered by not existing plan", cmd: "get instance ups-instance -n test-ns --plan wrong", golden: "output/get-instance-by-wrong-plan.txt"},
		...
		{name: "get instance filtered by not existing class", cmd: "get instance ups-instance -n test-ns --class wrong", golden: "output/get-instance-by-wrong-class.txt"},
