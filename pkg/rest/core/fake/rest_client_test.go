...
func TestCreateItem(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			&servicecatalog.ServiceBroker{ObjectMeta: metav1.ObjectMeta{Name: name1}, TypeMeta: metav1.TypeMeta{Kind: "Broker", APIVersion: "servicecatalog.k8s.io/v1alpha1"}},
			http.StatusCreated,
			1,
		},
		{
		...
		},
		{
			...
			NewWatcher(),
			newResponseWriter(),
			fmt.Sprintf("/apis/servicecatalog.k8s.io/v1alpha1/namespaces/%s/%s", ns1, tipe1), &servicecatalog.ServiceBroker{TypeMeta: metav1.TypeMeta{Kind: "Broker", APIVersion: "servicecatalog.k8s.io/v1alpha1"}},
			http.StatusCreated,
			2,
		},
	}
