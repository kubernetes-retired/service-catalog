...
type Controller interface {
	ListServices() ([]*brokerapi.Service, error)
	GetService(serviceID string) (*brokerapi.Service, error)
	CreateService(s *brokerapi.Service) error
...
func (c *registryController) ListServices() ([]*brokerapi.Service, error) {
	return c.storage.ListServices()
}

func (c *registryController) GetService(serviceID string) (*brokerapi.Service, error) {
	return c.storage.GetService(serviceID)
}

func (c *registryController) CreateService(s *brokerapi.Service) error {
