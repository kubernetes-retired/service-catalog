...
func newClusterServiceClasses(c *ServicecatalogV1alpha1Client) *clusterServiceClasses {
...
func (c *clusterServiceClasses) Get(name string, options v1.GetOptions) (result *v1alpha1.ClusterServiceClass, err error) {
	result = &v1alpha1.ClusterServiceClass{}
	err = c.client.Get().
...
func (c *clusterServiceClasses) List(opts v1.ListOptions) (result *v1alpha1.ClusterServiceClassList, err error) {
	result = &v1alpha1.ClusterServiceClassList{}
	err = c.client.Get().
		Resource("clusterserviceclasses").
...
func (c *clusterServiceClasses) Create(clusterServiceClass *v1alpha1.ClusterServiceClass) (result *v1alpha1.ClusterServiceClass, err error) {
	result = &v1alpha1.ClusterServiceClass{}
	err = c.client.Post().
		Resource("clusterserviceclasses").
...
func (c *clusterServiceClasses) Update(clusterServiceClass *v1alpha1.ClusterServiceClass) (result *v1alpha1.ClusterServiceClass, err error) {
	result = &v1alpha1.ClusterServiceClass{}
	err = c.client.Put().
		Resource("clusterserviceclasses").
...
func (c *clusterServiceClasses) UpdateStatus(clusterServiceClass *v1alpha1.ClusterServiceClass) (result *v1alpha1.ClusterServiceClass, err error) {
	result = &v1alpha1.ClusterServiceClass{}
	err = c.client.Put().
		Resource("clusterserviceclasses").
		Name(clusterServiceClass.Name).
...
func (c *clusterServiceClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterServiceClass, err error) {
	result = &v1alpha1.ClusterServiceClass{}
