...
func newClusterServiceBrokers(c *ServicecatalogV1alpha1Client) *clusterServiceBrokers {
...
func (c *clusterServiceBrokers) Update(clusterServiceBroker *v1alpha1.ClusterServiceBroker) (result *v1alpha1.ClusterServiceBroker, err error) {
	result = &v1alpha1.ClusterServiceBroker{}
	err = c.client.Put().
		Resource("clusterservicebrokers").
...
func (c *clusterServiceBrokers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterServiceBroker, err error) {
	result = &v1alpha1.ClusterServiceBroker{}
