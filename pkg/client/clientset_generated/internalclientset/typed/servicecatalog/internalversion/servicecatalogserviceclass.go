...
type ServiceCatalogServiceClassInterface interface {
	Create(*servicecatalog.ServiceCatalogServiceClass) (*servicecatalog.ServiceCatalogServiceClass, error)
	Update(*servicecatalog.ServiceCatalogServiceClass) (*servicecatalog.ServiceCatalogServiceClass, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*servicecatalog.ServiceCatalogServiceClass, error)
	List(opts v1.ListOptions) (*servicecatalog.ServiceCatalogServiceClassList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *servicecatalog.ServiceCatalogServiceClass, err error)
...
func newServiceCatalogServiceClasses(c *ServicecatalogClient) *serviceCatalogServiceClasses {
...
func (c *serviceCatalogServiceClasses) Create(serviceCatalogServiceClass *servicecatalog.ServiceCatalogServiceClass) (result *servicecatalog.ServiceCatalogServiceClass, err error) {
	result = &servicecatalog.ServiceCatalogServiceClass{}
	err = c.client.Post().
...
func (c *serviceCatalogServiceClasses) Update(serviceCatalogServiceClass *servicecatalog.ServiceCatalogServiceClass) (result *servicecatalog.ServiceCatalogServiceClass, err error) {
	result = &servicecatalog.ServiceCatalogServiceClass{}
	err = c.client.Put().
		Resource("servicecatalogserviceclasses").
...
func (c *serviceCatalogServiceClasses) Get(name string, options v1.GetOptions) (result *servicecatalog.ServiceCatalogServiceClass, err error) {
	result = &servicecatalog.ServiceCatalogServiceClass{}
	err = c.client.Get().
		Resource("servicecatalogserviceclasses").
		Name(name).
...
func (c *serviceCatalogServiceClasses) List(opts v1.ListOptions) (result *servicecatalog.ServiceCatalogServiceClassList, err error) {
	result = &servicecatalog.ServiceCatalogServiceClassList{}
	err = c.client.Get().
		Resource("servicecatalogserviceclasses").
...
func (c *serviceCatalogServiceClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *servicecatalog.ServiceCatalogServiceClass, err error) {
	result = &servicecatalog.ServiceCatalogServiceClass{}
