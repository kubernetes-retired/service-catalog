...
type ServiceCatalogBindingLister interface {
	...
	List(selector labels.Selector) (ret []*servicecatalog.ServiceCatalogBinding, err error)
...
// List lists all ServiceCatalogBindings in the indexer.
func (s *serviceCatalogBindingLister) List(selector labels.Selector) (ret []*servicecatalog.ServiceCatalogBinding, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*servicecatalog.ServiceCatalogBinding))
	})
	return ret, err
}
...
type ServiceCatalogBindingNamespaceLister interface {
	...
	Get(name string) (*servicecatalog.ServiceCatalogBinding, error)
...
// List lists all ServiceCatalogBindings in the indexer for a given namespace.
func (s serviceCatalogBindingNamespaceLister) List(selector labels.Selector) (ret []*servicecatalog.ServiceCatalogBinding, err error) {
...
// Get retrieves the ServiceCatalogBinding from the indexer for a given namespace and name.
func (s serviceCatalogBindingNamespaceLister) Get(name string) (*servicecatalog.ServiceCatalogBinding, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(servicecatalog.Resource("servicecatalogbinding"), name)
	}
	return obj.(*servicecatalog.ServiceCatalogBinding), nil
}
