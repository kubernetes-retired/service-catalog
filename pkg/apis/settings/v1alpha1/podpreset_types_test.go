...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the PodPreset resource tests

var _ = Describe("PodPreset", func() {
	var instance PodPreset
	var expected PodPreset
	var client PodPresetInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.SettingsV1alpha1().PodPresets("default")
