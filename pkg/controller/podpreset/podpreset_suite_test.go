...
func TestBee(t *testing.T) {
    ...
    RunSpecsWithDefaultAndCustomReporters(t, "PodPreset Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
    ...
    defer GinkgoRecover()
    Eventually(func() interface{} { return arguments.ControllerManager.GetController("PodPresetController") }).
        Should(Not(BeNil()))
    ctrl = arguments.ControllerManager.GetController("PodPresetController")
})
