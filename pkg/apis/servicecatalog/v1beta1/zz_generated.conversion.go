...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1beta1_SharedServicePlanStatus_To_servicecatalog_SharedServicePlanStatus,
		Convert_servicecatalog_SharedServicePlanStatus_To_v1beta1_SharedServicePlanStatus,
...
func autoConvert_v1beta1_ClusterServicePlanStatus_To_servicecatalog_ClusterServicePlanStatus(in *ClusterServicePlanStatus, out *servicecatalog.ClusterServicePlanStatus, s conversion.Scope) error {
	if err := Convert_v1beta1_SharedServicePlanStatus_To_servicecatalog_SharedServicePlanStatus(&in.SharedServicePlanStatus, &out.SharedServicePlanStatus, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_servicecatalog_ClusterServicePlanStatus_To_v1beta1_ClusterServicePlanStatus(in *servicecatalog.ClusterServicePlanStatus, out *ClusterServicePlanStatus, s conversion.Scope) error {
	if err := Convert_servicecatalog_SharedServicePlanStatus_To_v1beta1_SharedServicePlanStatus(&in.SharedServicePlanStatus, &out.SharedServicePlanStatus, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta1_SharedServicePlanStatus_To_servicecatalog_SharedServicePlanStatus(in *SharedServicePlanStatus, out *servicecatalog.SharedServicePlanStatus, s conversion.Scope) error {
	out.RemovedFromBrokerCatalog = in.RemovedFromBrokerCatalog
	return nil
}

// Convert_v1beta1_SharedServicePlanStatus_To_servicecatalog_SharedServicePlanStatus is an autogenerated conversion function.
func Convert_v1beta1_SharedServicePlanStatus_To_servicecatalog_SharedServicePlanStatus(in *SharedServicePlanStatus, out *servicecatalog.SharedServicePlanStatus, s conversion.Scope) error {
	return autoConvert_v1beta1_SharedServicePlanStatus_To_servicecatalog_SharedServicePlanStatus(in, out, s)
}

func autoConvert_servicecatalog_SharedServicePlanStatus_To_v1beta1_SharedServicePlanStatus(in *servicecatalog.SharedServicePlanStatus, out *SharedServicePlanStatus, s conversion.Scope) error {
	out.RemovedFromBrokerCatalog = in.RemovedFromBrokerCatalog
	return nil
}

// Convert_servicecatalog_SharedServicePlanStatus_To_v1beta1_SharedServicePlanStatus is an autogenerated conversion function.
func Convert_servicecatalog_SharedServicePlanStatus_To_v1beta1_SharedServicePlanStatus(in *servicecatalog.SharedServicePlanStatus, out *SharedServicePlanStatus, s conversion.Scope) error {
	return autoConvert_servicecatalog_SharedServicePlanStatus_To_v1beta1_SharedServicePlanStatus(in, out, s)
}
