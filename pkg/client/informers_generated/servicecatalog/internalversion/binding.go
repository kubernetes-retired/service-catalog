	...
	sharedIndexInformer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Servicecatalog().Bindings(api.NamespaceAll).List(internalOptions)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				...
				return client.Servicecatalog().Bindings(api.NamespaceAll).Watch(internalOptions)
			},
		},
...
func (f *bindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InternalInformerFor(&servicecatalog.Binding{}, newBindingInformer)
}
