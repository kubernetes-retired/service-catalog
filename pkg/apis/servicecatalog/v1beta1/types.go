...
// ClusterID holds an identifier for the cluster that will be
// generated by the Controller on startup.
type ClusterID struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	// ID is the identifier for the cluster
	ID string `json:"id"`
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object

// ClusterIDList doesn't exist and I don't know how to not generate it
type ClusterIDList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`

	Items []ClusterID `json:"items"` // there can be only one.
}
