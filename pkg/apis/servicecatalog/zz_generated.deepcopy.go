...
func (in *ClusterServiceBrokerSpec) DeepCopyInto(out *ClusterServiceBrokerSpec) {
	*out = *in
	in.SharedServiceBrokerSpec.DeepCopyInto(&out.SharedServiceBrokerSpec)
	if in.AuthInfo != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SharedServiceBrokerSpec) DeepCopyInto(out *SharedServiceBrokerSpec) {
	*out = *in
	if in.CABundle != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SharedServiceBrokerSpec.
func (in *SharedServiceBrokerSpec) DeepCopy() *SharedServiceBrokerSpec {
	if in == nil {
		return nil
	}
	out := new(SharedServiceBrokerSpec)
	in.DeepCopyInto(out)
	return out
}
