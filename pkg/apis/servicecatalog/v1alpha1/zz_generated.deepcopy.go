...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1alpha1_Parameters, InType: reflect.TypeOf(&Parameters{})},
...
func DeepCopy_v1alpha1_InstanceSpec(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if in.Parameters != nil {
			in, out := &in.Parameters, &out.Parameters
			*out = new(Parameters)
			if err := DeepCopy_v1alpha1_Parameters(*in, *out, c); err != nil {
				return err
			}
		}
		return nil
...
// DeepCopy_v1alpha1_Parameters is an autogenerated deepcopy function.
func DeepCopy_v1alpha1_Parameters(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*Parameters)
		out := out.(*Parameters)
		*out = *in
