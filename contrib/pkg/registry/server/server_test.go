...
import (
	...
	"github.com/kubernetes-incubator/service-catalog/contrib/pkg/registry/server"
...
func TestRegistryReturnsHTTPErrorOnError(t *testing.T) {
	...
	handler := server.CreateHandler(&testController{
		listServices: func() ([]*brokerapi.Service, error) {
...
type testController struct {
	t             *testing.T
	listServices  func() ([]*brokerapi.Service, error)
	getService    func(serviceID string) (*brokerapi.Service, error)
	createService func(s *brokerapi.Service) error
	deleteService func(serviceID string) error
}

func (c *testController) ListServices() ([]*brokerapi.Service, error) {
...
func (c *testController) GetService(serviceID string) (*brokerapi.Service, error) {
	if c.getService == nil {
...
func (c *testController) CreateService(s *brokerapi.Service) error {
