...
import (
	...
	"github.com/kubernetes-incubator/service-catalog/tools/junitreport/pkg/api"
		...
		},
		{
			...
			expectedSuites: &api.TestSuites{
				Suites: []*api.TestSuite{
					...
					{
						Name:       "github.com/kubernetes-incubator/service-catalog/tools/junitreport/pkg/parser/gotest/example",
						NumTests:   19,
						NumFailed:  9,
						Duration:   0.006,
