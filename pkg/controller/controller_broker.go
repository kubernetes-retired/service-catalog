...
const (
	...
	successServiceClusterBrokerDeletedReason  string = "DeletedSuccessfully"
	successServiceClusterBrokerDeletedMessage string = "The broker %v was deleted successfully."
