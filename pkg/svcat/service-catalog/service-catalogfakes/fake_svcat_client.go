...
type FakeSvcatClient struct {
	...
	ProvisionStub        func(string, string, string, *servicecatalog.ProvisionOptions) (*v1beta1.ServiceInstance, error)
	...
	RetrieveClassByIDStub        func(string) (*v1beta1.ClusterServiceClass, error)
	...
	RetrieveClassByPlanStub        func(servicecatalog.Plan) (*v1beta1.ClusterServiceClass, error)
...
func (fake *FakeSvcatClient) Provision(arg1 string, arg2 string, arg3 string, arg4 *servicecatalog.ProvisionOptions) (*v1beta1.ServiceInstance, error) {
...
func (fake *FakeSvcatClient) ProvisionCalls(stub func(string, string, string, *servicecatalog.ProvisionOptions) (*v1beta1.ServiceInstance, error)) {
	fake.provisionMutex.Lock()
...
func (fake *FakeSvcatClient) RetrieveClassByID(arg1 string) (*v1beta1.ClusterServiceClass, error) {
...
func (fake *FakeSvcatClient) RetrieveClassByIDCalls(stub func(string) (*v1beta1.ClusterServiceClass, error)) {
	fake.retrieveClassByIDMutex.Lock()
...
func (fake *FakeSvcatClient) RetrieveClassByIDReturns(result1 *v1beta1.ClusterServiceClass, result2 error) {
	fake.retrieveClassByIDMutex.Lock()
	defer fake.retrieveClassByIDMutex.Unlock()
...
func (fake *FakeSvcatClient) RetrieveClassByIDReturnsOnCall(i int, result1 *v1beta1.ClusterServiceClass, result2 error) {
	fake.retrieveClassByIDMutex.Lock()
	defer fake.retrieveClassByIDMutex.Unlock()
	fake.RetrieveClassByIDStub = nil
...
func (fake *FakeSvcatClient) RetrieveClassByPlan(arg1 servicecatalog.Plan) (*v1beta1.ClusterServiceClass, error) {
...
func (fake *FakeSvcatClient) RetrieveClassByPlanCalls(stub func(servicecatalog.Plan) (*v1beta1.ClusterServiceClass, error)) {
	fake.retrieveClassByPlanMutex.Lock()
...
func (fake *FakeSvcatClient) RetrieveClassByPlanReturns(result1 *v1beta1.ClusterServiceClass, result2 error) {
	fake.retrieveClassByPlanMutex.Lock()
	defer fake.retrieveClassByPlanMutex.Unlock()
...
func (fake *FakeSvcatClient) RetrieveClassByPlanReturnsOnCall(i int, result1 *v1beta1.ClusterServiceClass, result2 error) {
	fake.retrieveClassByPlanMutex.Lock()
	defer fake.retrieveClassByPlanMutex.Unlock()
	fake.RetrieveClassByPlanStub = nil
...
func (fake *FakeSvcatClient) RetrieveClassesCalls(stub func(servicecatalog.ScopeOptions) ([]servicecatalog.Class, error)) {
	fake.retrieveClassesMutex.Lock()
...
func (fake *FakeSvcatClient) WaitForBrokerCalls(stub func(string, time.Duration, *time.Duration) (servicecatalog.Broker, error)) {
	fake.waitForBrokerMutex.Lock()
