	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "parametersFrom":
			if r.TryDecodeAsNil() {
				...
				yyv8 := &x.ParametersFrom
				yym9 := z.DecBinary()
				_ = yym9
				if false {
				} else {
					h.decSliceParametersFromSource((*[]ParametersFromSource)(yyv8), d)
				}
			}
		case "parameters":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					h.decSliceParameter((*[]Parameter)(yyv10), d)
				}
			}
		case "externalID":
			if r.TryDecodeAsNil() {
...
func (x *InstanceSpec) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		yyv19 := &x.ParametersFrom
		yym20 := z.DecBinary()
		_ = yym20
		if false {
		} else {
			h.decSliceParametersFromSource((*[]ParametersFromSource)(yyv19), d)
		}
	}
	yyj14++
	if yyhl14 {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceParameter((*[]Parameter)(yyv21), d)
		}
	}
	yyj14++
	if yyhl14 {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "valueFrom":
			if r.TryDecodeAsNil() {
				...
				if x.ValueFrom == nil {
					x.ValueFrom = new(ParameterSource)
				}
...
func (x ParameterValueType) CodecEncodeSelf(e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	yym1 := z.EncBinary()
...
func (x *ParameterValueType) CodecDecodeSelf(d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	yym1 := z.DecBinary()
...
func (x *ParameterSource) CodecEncodeSelf(e *codec1978.Encoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	if x == nil {
...
func (x *ParameterSource) CodecDecodeSelf(d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	yym1 := z.DecBinary()
...
func (x *ParameterSource) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yys3Slc = z.DecScratchBuffer() // default slice to decode into
...
func (x *ParameterSource) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	var h codecSelfer1234
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
	var yyj5 int
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "value":
			if r.TryDecodeAsNil() {
				...
				if x.Value == nil {
					x.Value = new(pkg4_runtime.RawExtension)
				}
				yym5 := z.DecBinary()
				_ = yym5
				if false {
				} else if z.HasExtensions() && z.DecExt(x.Value) {
				} else if !yym5 && z.IsJSONHandle() {
					z.DecJSONUnmarshal(x.Value)
				} else {
					z.DecFallback(x.Value, false)
				}
			}
		case "secretRef":
			if r.TryDecodeAsNil() {
