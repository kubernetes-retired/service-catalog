...
2 different demos were given at 10/3/2016’s sig-service-catalog meeting, both extremely promising. Each differed in quite a few ways, including how consumers used Kubernetes resources to communicate.
