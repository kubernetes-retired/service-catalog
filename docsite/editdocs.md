...
$( document ).ready(function() {
    if(forwarding) {
        ...
        $("#continueEditButton").attr("href", "https://github.com/kubernetes-sigs/service-catalog/edit/master{{ page.docsbranch }}/" + forwarding)
        $("#viewOnGithubButton").text("View " + forwarding + " on GitHub");
        $("#viewOnGithubButton").attr("href", "https://github.com/kubernetes-sigs/service-catalog/blob/master{{ page.docsbranch }}/" + forwarding)
    } else {
...
<p><a class="button" href="https://github.com/kubernetes-sigs/service-catalog/tree/master/docs">Browse this site's source code</a></p>
