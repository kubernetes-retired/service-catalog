...
func newClusterServicePlans(c *ServicecatalogV1alpha1Client) *clusterServicePlans {
...
func (c *clusterServicePlans) Get(name string, options v1.GetOptions) (result *v1alpha1.ClusterServicePlan, err error) {
	result = &v1alpha1.ClusterServicePlan{}
	err = c.client.Get().
...
func (c *clusterServicePlans) List(opts v1.ListOptions) (result *v1alpha1.ClusterServicePlanList, err error) {
	result = &v1alpha1.ClusterServicePlanList{}
	err = c.client.Get().
		Resource("clusterserviceplans").
...
func (c *clusterServicePlans) Create(clusterServicePlan *v1alpha1.ClusterServicePlan) (result *v1alpha1.ClusterServicePlan, err error) {
	result = &v1alpha1.ClusterServicePlan{}
	err = c.client.Post().
		Resource("clusterserviceplans").
...
func (c *clusterServicePlans) Update(clusterServicePlan *v1alpha1.ClusterServicePlan) (result *v1alpha1.ClusterServicePlan, err error) {
	result = &v1alpha1.ClusterServicePlan{}
	err = c.client.Put().
		Resource("clusterserviceplans").
...
func (c *clusterServicePlans) UpdateStatus(clusterServicePlan *v1alpha1.ClusterServicePlan) (result *v1alpha1.ClusterServicePlan, err error) {
	result = &v1alpha1.ClusterServicePlan{}
	err = c.client.Put().
		Resource("clusterserviceplans").
		Name(clusterServicePlan.Name).
...
func (c *clusterServicePlans) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterServicePlan, err error) {
	result = &v1alpha1.ClusterServicePlan{}
