...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1beta1_ClusterID_To_servicecatalog_ClusterID,
		Convert_servicecatalog_ClusterID_To_v1beta1_ClusterID,
		Convert_v1beta1_ClusterIDList_To_servicecatalog_ClusterIDList,
		Convert_servicecatalog_ClusterIDList_To_v1beta1_ClusterIDList,
...
func autoConvert_v1beta1_ClusterID_To_servicecatalog_ClusterID(in *ClusterID, out *servicecatalog.ClusterID, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.ID = in.ID
	return nil
}

// Convert_v1beta1_ClusterID_To_servicecatalog_ClusterID is an autogenerated conversion function.
func Convert_v1beta1_ClusterID_To_servicecatalog_ClusterID(in *ClusterID, out *servicecatalog.ClusterID, s conversion.Scope) error {
	return autoConvert_v1beta1_ClusterID_To_servicecatalog_ClusterID(in, out, s)
}

func autoConvert_servicecatalog_ClusterID_To_v1beta1_ClusterID(in *servicecatalog.ClusterID, out *ClusterID, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.ID = in.ID
	return nil
}

// Convert_servicecatalog_ClusterID_To_v1beta1_ClusterID is an autogenerated conversion function.
func Convert_servicecatalog_ClusterID_To_v1beta1_ClusterID(in *servicecatalog.ClusterID, out *ClusterID, s conversion.Scope) error {
	return autoConvert_servicecatalog_ClusterID_To_v1beta1_ClusterID(in, out, s)
}

func autoConvert_v1beta1_ClusterIDList_To_servicecatalog_ClusterIDList(in *ClusterIDList, out *servicecatalog.ClusterIDList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]servicecatalog.ClusterID)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1beta1_ClusterIDList_To_servicecatalog_ClusterIDList is an autogenerated conversion function.
func Convert_v1beta1_ClusterIDList_To_servicecatalog_ClusterIDList(in *ClusterIDList, out *servicecatalog.ClusterIDList, s conversion.Scope) error {
	return autoConvert_v1beta1_ClusterIDList_To_servicecatalog_ClusterIDList(in, out, s)
}

func autoConvert_servicecatalog_ClusterIDList_To_v1beta1_ClusterIDList(in *servicecatalog.ClusterIDList, out *ClusterIDList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]ClusterID)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_servicecatalog_ClusterIDList_To_v1beta1_ClusterIDList is an autogenerated conversion function.
func Convert_servicecatalog_ClusterIDList_To_v1beta1_ClusterIDList(in *servicecatalog.ClusterIDList, out *ClusterIDList, s conversion.Scope) error {
	return autoConvert_servicecatalog_ClusterIDList_To_v1beta1_ClusterIDList(in, out, s)
}
