...
func GetOpenAPIDefinitions(ref openapi.ReferenceCallback) map[string]openapi.OpenAPIDefinition {
	return map[string]openapi.OpenAPIDefinition{
		...
		"k8s.io/kubernetes/pkg/api/v1.Container": {
			...
			Dependencies: []string{
				"k8s.io/kubernetes/pkg/api/v1.ContainerPort", "k8s.io/kubernetes/pkg/api/v1.EnvVar", "k8s.io/kubernetes/pkg/api/v1.Lifecycle", "k8s.io/kubernetes/pkg/api/v1.Probe", "k8s.io/kubernetes/pkg/api/v1.ResourceRequirements", "k8s.io/kubernetes/pkg/api/v1.SecurityContext", "k8s.io/kubernetes/pkg/api/v1.VolumeMount"},
		},
		...
		"k8s.io/kubernetes/pkg/api/v1.ObjectMeta": {
						...
						"ownerReferences": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("k8s.io/kubernetes/pkg/api/v1.OwnerReference"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"k8s.io/kubernetes/pkg/api/v1.OwnerReference", "k8s.io/kubernetes/pkg/apis/meta/v1.Time"},
		},
		"k8s.io/kubernetes/pkg/api/v1.ObjectReference": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
		...
		"k8s.io/kubernetes/pkg/api/v1.OwnerReference": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
		...
		"k8s.io/kubernetes/pkg/api/v1.PodSpec": {
			...
			Dependencies: []string{
				"k8s.io/kubernetes/pkg/api/v1.Container", "k8s.io/kubernetes/pkg/api/v1.LocalObjectReference", "k8s.io/kubernetes/pkg/api/v1.PodSecurityContext", "k8s.io/kubernetes/pkg/api/v1.Volume"},
		},
		...
		"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.Binding": {
			...
			Dependencies: []string{
				"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.BindingSpec", "github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.BindingStatus", "k8s.io/kubernetes/pkg/api/v1.ObjectMeta"},
			spec.VendorExtensible: {
				Extensions: spec.Extensions{
					"x-kubernetes-display-all": "true",
				},
			},
		},
		...
		"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.BindingList": {
			...
			Dependencies: []string{
				"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.Binding", "k8s.io/kubernetes/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.BindingSpec": {
			...
			Dependencies: []string{
				"k8s.io/kubernetes/pkg/api/v1.ObjectReference", "k8s.io/kubernetes/pkg/apis/meta/v1.LabelSelector", "k8s.io/kubernetes/pkg/runtime.RawExtension"},
		},
		...
		"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.Broker": {
			...
			Dependencies: []string{
				"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.BrokerSpec", "github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.BrokerStatus", "k8s.io/kubernetes/pkg/api/v1.ObjectMeta"},
		},
		...
		"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.BrokerList": {
			...
			Dependencies: []string{
				"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.Broker", "k8s.io/kubernetes/pkg/apis/meta/v1.ListMeta"},
		},
		...
		"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.Instance": {
			...
			Dependencies: []string{
				"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.InstanceSpec", "github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.InstanceStatus", "k8s.io/kubernetes/pkg/api/v1.ObjectMeta"},
			spec.VendorExtensible: {
				Extensions: spec.Extensions{
					"x-kubernetes-display-all": "true",
				},
		...
		"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.InstanceList": {
			...
			Dependencies: []string{
				"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.Instance", "k8s.io/kubernetes/pkg/apis/meta/v1.ListMeta"},
		},
		...
		"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.ServiceClass": {
			...
			Dependencies: []string{
				"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.ServicePlan", "k8s.io/kubernetes/pkg/api/v1.ObjectMeta"},
		},
		"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.ServiceClassList": {
			...
			Dependencies: []string{
				"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1alpha1.ServiceClass", "k8s.io/kubernetes/pkg/apis/meta/v1.ListMeta"},
		},
