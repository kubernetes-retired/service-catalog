...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_servicecatalog_DesiredPlan, InType: reflect.TypeOf(&DesiredPlan{})},
...
// DeepCopy_servicecatalog_DesiredPlan is an autogenerated deepcopy function.
func DeepCopy_servicecatalog_DesiredPlan(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*DesiredPlan)
		out := out.(*DesiredPlan)
		*out = *in
