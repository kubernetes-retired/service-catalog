...
type InstanceLister interface {
	...
	List(selector labels.Selector) (ret []*servicecatalog.Instance, err error)
...
// List lists all Instances in the indexer.
func (s *instanceLister) List(selector labels.Selector) (ret []*servicecatalog.Instance, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*servicecatalog.Instance))
	})
	return ret, err
}
...
// List lists all Instances in the indexer for a given namespace.
func (s instanceNamespaceLister) List(selector labels.Selector) (ret []*servicecatalog.Instance, err error) {
...
// Get retrieves the Instance from the indexer for a given namespace and name.
func (s instanceNamespaceLister) Get(name string) (*servicecatalog.Instance, error) {
	...
	return obj.(*servicecatalog.Instance), nil
}
